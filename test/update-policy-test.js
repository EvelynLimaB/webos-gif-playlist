...
if (!policy.isNewer("0.2.3", "0.2.4")) {
    throw new Error("newer version was not detected");
}
if (policy.isNewer("0.2.4", "0.2.4")) {
...
manifest = {
    ...
    ipkUrl: "https://github.com/EvelynLimaB/webos-gif-playlist/releases/download/v0.2.4/com.evelyn.webosgifplaylist_0.2.4_all.ipk",
    rootRequired: true,
    ipkHash: {
...
if (policy.validateManifest(manifest).version !== "0.2.4") {
...
expectRejected(function(value) { value.version = "0.2.4-beta"; }, "unsupported version format was accepted");
...
policy.setPendingVersion(storage, "0.2.4");
if (policy.pendingVersion(storage) !== "0.2.4") {
