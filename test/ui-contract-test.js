...
while ((match = lookupPattern.exec(view)) !== null) {
    if (!ids[match[1]]) {
        throw new Error("view.js references missing HTML id: " + match[1]);
    }
}
...
["init", "preflight", "status", "list", "addUrl", "remove", "move", "setOption", "applyTemporary", "enable", "disable", "reset", "testScreensaver"].forEach(function(name) {
